  ...
  const handleUserMessage = () => {
    ...
    setChatHistory((prev) => [
      ...
      { type: "user", content: userInput },
      {
        type: "answer",
        content:
          "Thank you for your message! For immediate assistance, please contact our support team at support@clothcore.com or call (555) 123-4567. You can also select from the common questions below.",
      },
    ])
    setUserInput("")
  }
            ...
            <CardHeader className="bg-orange-500 text-white rounded-t-lg">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <CardTitle className="text-lg">ClothCore Assistant</CardTitle>
